...
public class MainFrame extends JFrame
{
	...
	protected JMenuBar createMenuBar()
	{
		...
		menu = new JMenu("进货管理");
		menuBar.add(menu);
		menuItem = new JMenuItem("进货");
		menuItem.addActionListener(MainAction.importGoods());
		menu.add(menuItem);
		menuItem = new JMenuItem("退货");
		...
		menu = new JMenu("销售管理");
		menuBar.add(menu);
		menuItem = new JMenuItem("销售");
		menuItem.addActionListener(MainAction.sales());
		menu.add(menuItem);
		menuItem = new JMenuItem("退售");
