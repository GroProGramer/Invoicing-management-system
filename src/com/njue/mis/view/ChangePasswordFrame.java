...
public class ChangePasswordFrame extends JInternalFrame
{
	...
	public ChangePasswordFrame()
	{
		...
		label_old_password.setForeground(Color.WHITE);
		label_new_password = new JLabel("新密码：        ");
		label_new_password.setForeground(Color.WHITE);
		...
		this.setContentPane(new JPanel()
		{
			public void paintComponent(Graphics g)
			{
				...
				g.drawImage(new ImageIcon(LoginFrame.class.getResource("images/background.jpg"))
						.getImage(), 0, 0, null);
			}
		});
		this.add(empty1);
